...
if(isset($_POST["register"]))
{
	...
	if($no_of_row > 0)
	{
		$message = '<label class="text-danger">Email existe</label>';
	}
	else
	{
		...
		if(isset($result))
		{
			...
			$mail->Username = 'lavieillesardine@gmail.com';					//Sets SMTP username
			$mail->Password = 'Sardine1';					//Sets SMTP password
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form method="post" id="register_form">
						...
						<div class="form-group">
							<input type="submit" name="register" id="register" value="Inscription" class="btn btn-info" />
						</div>
					</form>
					<p align="right"><a href="login.php">Connexion</a></p>
				</div>
			</div>
		</div>
	</body>

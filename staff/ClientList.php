...
try {
    ...
    <div class="container" style="width:100% ">
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="clientTable">
            ...
            $clientList = $bdd->prepare("SELECT * FROM compte WHERE Status='C' ");
            $clientList->execute();
            while($client = $clientList->fetch()){
                ...
                ?>
                <tr>
                    <td style="text-align:center; word-break:break-all; "> <?php echo $client ['ID_Client']; ?></td>
                    <td style="text-align:center; word-break:break-all; "> <?php echo $client ['Civilite']; ?></td>
                    <td style="text-align:center; word-break:break-all; "> <?php echo $client ['PRENOM']; ?></td>
                    <td style="text-align:center; word-break:break-all; "> <?php echo $client ['Nom']; ?></td>
                    <td style="text-align:center; word-break:break-all; "> <?php echo $client ['Tel']; ?></td>
                    <td style="text-align:center; word-break:break-all; "> <?php echo $client ['Email']; ?></td>
                                    ...
                                    <form class="form-horizontal" method="post" id="edit_client" action="EditClient.php">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for PRENOM> Prenom : </label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="PRENOM" id= "PRENOM" required value=<?php echo $client['PRENOM']; ?>>
                                                </div>
                                            </div><br>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for Nom> Nom : </label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="Nom" id="Nom" required value=<?php echo $client['Nom']; ?>>
                                                </div>
                                            </div><br>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for Tel> Téléphone : </label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="Tel" id="Tel" required value=<?php echo $client['Tel']; ?>>
                                                </div>
                                            </div><br>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for Email> E-mail : </label>
                                                <div class="col-sm-3">
                                                    <input type="email" class="form-control" name="Email" id="Email" required value=<?php echo $client['Email']; ?>>
                                                </div>
                                            </div><br>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for Password> Mot de passe : </label>
                                                <div class="col-sm-3">
                                                    <input type="password" class="form-control" name="Password" id="Password">
                                                    <input type="hidden" class="form-control" name="Password_def" id="Password_def" value=<?php echo $client['Password']; ?>>
                                                </div>
                                            </div><br><br>
                                            <?php
                    ...
                    <div id="delete<?php  echo $id;?>" class="modal fade" role="dialog">
                        ...
                        <div class="modal-body">
                            <p><div style="font-size:larger;" class="alert alert-danger">Etes-vous sûr de vouloir effacer les données de <b style="color:red;"><?php echo $client['PRENOM']." ".$client['Nom'] ; ?></b> ? <br> Cette action n'est pas réversible</p>
                        </div>
                        <br>
                        <div class="modal-footer">
